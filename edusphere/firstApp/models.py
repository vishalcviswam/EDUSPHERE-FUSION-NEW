...
class Book(models.Model):
    creator = models.ForeignKey(ContentCreators, on_delete=models.CASCADE, related_name='books')
    # The content field will be removed as the content is stored on the blockchain

    def __str__(self):
        return f"Book by {self.creator.user.username}"